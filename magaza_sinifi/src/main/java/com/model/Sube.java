...
public class Sube {
    ...
    public Sube(String subeKodu, String subeAdi, String adres, String telefon, String bolgeYoneticisi) {
        this.subeKodu = subeKodu;
        this.subeAdi = subeAdi;
        this.adres = adres;
        this.telefon = telefon;
        this.bolgeYoneticisi = bolgeYoneticisi;
    ...
    public void calisanEkle(Calisan calisan) {
        if (aktif) {
            ...
            System.out.println("Güncel çalışan sayısı: " + calisanlar.size());
        } else {
    ...
    public void calisanCikar(String tcNo) {
        ...
        if (silinecekCalisan != null) {
            ...
            System.out.println(silinecekCalisan.getAd() + " " + silinecekCalisan.getSoyad() + 
                             " şubeden çıkarıldı.");
            System.out.println("Kalan çalışan sayısı: " + calisanlar.size());
        } else {
            System.out.println("Bu TC numarasına sahip çalışan bulunamadı: " + tcNo);
        }
    }
    ...
    public void ciroGuncelle(double miktar) {
        if (aktif) {
            aylikCiro += miktar;
            System.out.println(subeAdi + " şubesinin cirosu güncellendi.");
            System.out.println("Yeni ciro: " + aylikCiro + " TL");
        } else {
    ...
    public void subeyiAc() {
        if (!aktif) {
            ...
            System.out.println("Bölge Yöneticisi: " + bolgeYoneticisi);
        } else {
    ...
    public void calisanlariListele() {
        ...
        if (calisanlar.isEmpty()) {
            ...
            System.out.println("Toplam " + calisanlar.size() + " çalışan:");
            for (Calisan calisan : calisanlar) {
                System.out.println("\n- " + calisan.getAd() + " " + calisan.getSoyad());
                System.out.println("  Pozisyon: " + calisan.getPozisyon());
    ...
    public String getBolgeYoneticisi() { return bolgeYoneticisi; }
    public void setBolgeYoneticisi(String bolgeYoneticisi) { this.bolgeYoneticisi = bolgeYoneticisi; }
} 